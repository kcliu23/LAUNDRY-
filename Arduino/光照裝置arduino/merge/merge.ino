...
void loop() {
  ...
  {   
    ...
    else if(ble_rx_buffer[0]=='s' && ble_rx_buffer[1]=='t')     //set time
    {
          ...
          Serial.print(ble_rx_buffer[12]-48);
          Serial.print(ble_rx_buffer[13]-48);
          close1=true;
    }
